...
class AuthController extends Controller
{
    ...
    {
        $this->auth->password()->sendResetPasswordEmail($request->get('email'));
    ...
    public function profile()
    {
        ...
        return $this->response('auth.profile.get_profile_success', ['profile' => $profile]);
    }
    ...
    public function updateProfile(AuthUpdateProfileRequest $request)
    {
        ...
        return $this->response('auth.profile.update_profile_success', ['profile' => $profile]);
    }
    ...
    /**
     * Response device id for website
     *
     * @return JsonResponse
     */
    public function responseDeviceId()
    {
        $deviceId = $this->auth->device()->responseDeviceId();

        return $this->response('auth.get_device_id.success', [ 'device_id' => $deviceId ]);
    }
